...
First line of each test case or query contains two integer values,
 'N' and 'M', separated by a single space. They represent the 'rows'
...
Output Format :
For each test case, print the sum of every ith row elements in a single
...
10 30 18 -5 
 */
public class FRowSum {

	public static void main(String[] args) {
		int[][] arr2d = {{1,2,3,4 },{9,8,7,6},{3,4,5,6},{-1,1,-10,5}};
		sumEachRow(arr2d);
	}
