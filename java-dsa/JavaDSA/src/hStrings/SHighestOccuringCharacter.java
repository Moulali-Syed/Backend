...
Expected Output: 'a'
Since 'a' has appeared four times in the string which
 happens to be the highest frequency character, the answer would be 'a'.
...
x
 */
public class SHighestOccuringCharacter {
...
//			System.out.println(ind);
		...
		System.out.println((char)highestInd);
	}
}
