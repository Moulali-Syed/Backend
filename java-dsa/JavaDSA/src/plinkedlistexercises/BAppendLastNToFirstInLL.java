...
You have been given a singly linked list of integers
 along with an integer 'N'. Write a function to append
  the last 'N' nodes towards the front of the singly linked list
 ...
 */
public class BAppendLastNToFirstInLL {
	...
	public static void main(String[] args) {
		...
		Node<Integer> newHead = appendLastNToFirst(temp,2);
		
		Node<Integer> newTempHead = newHead;
		while(newTempHead != null) {
			System.out.print(newTempHead.data+"  ");
